function camera = sensor_models(name)
    ...
    switch name
        ...
        case "Nikon_D5100"
            ...
            camera.cgain2read_noise = @(cgain) 1.94863 * cgain + 0.69789; # DN
            camera.dark_current = 0.401177; # e-/s/pix
            camera.bias = 129; # DN
            camera.cgain = [ 0.391267 0.434638 0.553248 0.69269 0.874804 1.11363 1.43024 1.77036 2.2299 3.27807 3.65635 4.63258 5.90305 5.88421 5.85468 5.91954 5.84929 5.92751 5.91549 ];
