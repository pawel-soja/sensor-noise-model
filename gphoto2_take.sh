...
# Low ISO: dark current is only ~0.04 DN/s at ISO 100 (Z6 II), so long exposures are
# needed to get a usable slope. High ISO: noise grows fast, a few points are enough.
ISOS_LOW=(100 200 400 640 800 1600)
TIMES_LOW=("0,0010s" "0,1000s" "1,0000s" "4,0000s" "8,0000s" "15,0000s" "30,0000s")
